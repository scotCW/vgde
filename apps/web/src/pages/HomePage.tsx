  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center gap-8 px-4">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">The Voting Game</h1>
        <button className="text-sm text-slate-400 hover:text-slate-200" onClick={() => void logout()}>
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
        ...
        <form onSubmit={joinGame} className="flex gap-2">
          <input
            className="flex-1 rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 uppercase tracking-widest"
            placeholder="CODE"
            value={joinCode}
      ...
      <Link to="/question-bank" className="text-center text-sm text-indigo-400 underline hover:text-indigo-300">
